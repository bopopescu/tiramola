...
#            print stdout.readlines()
            ...
            sftp.put( "/tmp/mains", "/opt/hadoop-0.20.2/conf/mains")
            sftp.put( "/tmp/subordinates", "/opt/hadoop-0.20.2/conf/subordinates")
            os.system("sed -i '/^$/d' /tmp/hbase-site.xml")
            sftp.put( "/tmp/hbase-site.xml", "/opt/hbase-0.20.6/conf/hbase-site.xml")
            sftp.put( "/tmp/subordinates", "/opt/hbase-0.20.6/conf/regionservers")
